...
class QuizDropDownData(QuizData):
    """Specific derived class that contains the functionality for question type: Drop Down. Functinality includes
    ...
    def get_quiz_question_content(self, doc_dict):
        ...
        """
        return {'type': 'dropdown', 'question': doc_dict['content'], 'options': doc_dict['options']}
